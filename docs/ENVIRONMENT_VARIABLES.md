...
| `NEXT_PUBLIC_BAIDU_MAP_AK`  | Mandatory public | Baidu JSAPI GL map rendering for privacy-safe Meet discovery | Baidu Maps Open Platform → browser-side JavaScript API key; restrict the domain allowlist to Kondo Production and approved Preview origins.  |
