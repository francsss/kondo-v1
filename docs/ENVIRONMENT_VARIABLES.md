...
| `NEXT_PUBLIC_APP_URL`       | Mandatory        | Canonical metadata and verification/reset/digest links | The exact public HTTPS origin, such as `https://kondo-v1.vercel.app`, with no path or trailing slash.                                        |
