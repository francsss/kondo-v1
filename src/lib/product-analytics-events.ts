export const PRODUCT_EVENTS = {
  ...
  NAVIGATOR_VIEWED: "navigator_viewed",
  NAVIGATOR_ACTION_OPENED: "navigator_action_opened",
  NAVIGATOR_ACTION_COMPLETED: "navigator_action_completed",
  NAVIGATOR_ACTION_DISMISSED: "navigator_action_dismissed",
  NAVIGATOR_ACTION_DEFERRED: "navigator_action_deferred",
  PERSONALIZED_HOME_VIEWED: "personalized_home_viewed",
  SAVED_HUB_VIEWED: "saved_hub_viewed",
  ...
  // Part 5 — Opportunities. Property payloads stay category-level only: no
  // applicant identity, answers, document names or eligibility reasons.
  OPPORTUNITIES_HOME_VIEWED: "opportunities_home_viewed",
  OPPORTUNITY_CATEGORY_OPENED: "opportunity_category_opened",
  OPPORTUNITY_SEARCH_STARTED: "opportunity_search_started",
  ...
  OPPORTUNITY_ELIGIBILITY_VIEWED: "eligibility_summary_viewed",
  OPPORTUNITY_APPLICATION_STARTED: "opportunity_application_started",
  OPPORTUNITY_APPLICATION_DRAFT_SAVED: "application_draft_saved",
  OPPORTUNITY_APPLICATION_DOCUMENT_SELECTED: "application_document_selected",
  OPPORTUNITY_APPLICATION_SUBMITTED: "opportunity_application_submitted",
  OPPORTUNITY_APPLICATION_STATUS_VIEWED: "application_status_viewed",
  OPPORTUNITY_APPLICATION_WITHDRAWN: "application_withdrawn",
  OPPORTUNITY_EXTERNAL_APPLICATION_OPENED:
    "opportunity_external_application_opened",
  ORGANIZATION_OPPORTUNITY_CREATED: "organization_opportunity_created",
  ORGANIZATION_OPPORTUNITY_SUBMITTED: "organization_opportunity_submitted",
  ORGANIZATION_OPPORTUNITY_PUBLISHED: "organization_opportunity_published",
  ORGANIZATION_APPLICATIONS_VIEWED: "organization_applications_viewed",
  ORGANIZATION_APPLICATION_STATUS_CHANGED:
    "organization_application_status_changed",
  OPPORTUNITY_REPORT_SUBMITTED: "opportunity_report_submitted",
  STUDENT_HUB_OPPORTUNITY_OPENED: "student_hub_opportunity_opened",
  DISCOVER_OPENED: "discover_opened",
  DISCOVER_SEARCHED: "discover_searched",
  DISCOVER_FILTER_APPLIED: "discover_filter_applied",
  DISCOVER_RESULT_OPENED: "discover_result_opened",
  DISCOVER_RECOMMENDATION_EXPLAINED: "discover_recommendation_explained",
  ESSENTIALS_OPENED: "essentials_opened",
  ORGANIZATION_PRODUCT_CREATED: "organization_product_created",
  ORGANIZATION_PRODUCT_LIFECYCLE_CHANGED:
    "organization_product_lifecycle_changed",
  ORGANIZATION_PRODUCT_VIEWED: "organization_product_viewed",
  ORGANIZATION_PRODUCT_SAVED: "organization_product_saved",
  ORGANIZATION_PRODUCT_INQUIRY_SENT: "organization_product_inquiry_sent",
  ORGANIZATION_SERVICE_CREATED: "organization_service_created",
  ORGANIZATION_SERVICE_LIFECYCLE_CHANGED:
    "organization_service_lifecycle_changed",
  ORGANIZATION_SERVICE_VIEWED: "organization_service_viewed",
  ORGANIZATION_SERVICE_SAVED: "organization_service_saved",
  ORGANIZATION_SERVICE_INQUIRY_SENT: "organization_service_inquiry_sent",
  PAYMENT_UNAVAILABLE_VIEWED: "payment_unavailable_viewed",
